...
const Home = () => {
  return (
    <>
      ...
      <View style={{borderWidth: 0,marginLeft: 30,marginRight: 30,backgroundColor: 'rgba(255, 255, 255, 0.6)',marginTop: -120,  borderRadius: 200,paddingTop: 20,paddingBottom: 20}}>
        <View style={{borderWidth: 0,marginLeft: 30,marginRight: 30,backgroundColor: '#fcf8f6',  borderRadius: 200,paddingTop: 20,paddingBottom: 20}}>
      ...
      <Text style={styles.pizzaSizeHeading}>
          Choose your size
        </Text>
      </View>
    </>
